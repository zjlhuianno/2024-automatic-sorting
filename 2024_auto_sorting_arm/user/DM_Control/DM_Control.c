...
void DM_PID_Init(void)
{
	...
	PID_init(&DM4340_speed_pid,PID_POSITION,DM4340_speed_PID,DM4340_speed_max_out,DM4340_speed_max_iout);

	//DM4340位置环。
	DM4340_pos_PID[0]=DM4340_pos_kp;
	DM4340_pos_PID[1]=DM4340_pos_ki;
	DM4340_pos_PID[2]=DM4340_pos_kd;
	PID_init(&DM4340_pos_pid,PID_POSITION,DM4340_pos_PID,DM4340_pos_max_out,DM4340_pos_max_iout);

	//DM4310速度环。
	DM4310_speed_PID[0]=DM4310_speed_kp;
	DM4310_speed_PID[1]=DM4310_speed_ki;
	DM4310_speed_PID[2]=DM4310_speed_kd;
	PID_init(&DM4310_speed_pid,PID_POSITION,DM4310_speed_PID,DM4310_speed_max_out,DM4310_speed_max_iout);
	
	//DM4310位置环。
	DM4310_pos_PID[0]=DM4310_pos_kp;
	DM4310_pos_PID[1]=DM4310_pos_ki;
	DM4310_pos_PID[2]=DM4310_pos_kd;
	PID_init(&DM4310_pos_pid,PID_POSITION,DM4310_pos_PID,DM4310_pos_max_out,DM4310_pos_max_iout);
