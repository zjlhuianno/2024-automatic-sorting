...
#define DM4340_ZERO_POS_OFFSET		21-6-12-25	//DM4340的编码器值p_int的零位置偏置，每次拆开后重装须更改。
#define DM4310_ZERO_POS_OFFSET		2848-5696+31	//DM4310的编码器值p_int的零位置偏置，每次拆开后重装须更改。
