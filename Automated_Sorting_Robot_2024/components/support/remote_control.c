...
//  channels[7]  = ((sbus_buf[10]>>5|sbus_buf[11]<<3) & 0x07FF); // & the other 8 + 2 channels if you need them
...
//	
//	
//	rc_ctrl->rc.ch[0]=channels[0]-1000;
//	rc_ctrl->rc.ch[1]=channels[1]-1000;
//	if(channels[4]<500)
//	{
//	rc_ctrl->rc.s[0]=1;
//	}
//	else if(channels[4]>1700)
//	{
//	rc_ctrl->rc.s[0]=2;
//	}
//	else
