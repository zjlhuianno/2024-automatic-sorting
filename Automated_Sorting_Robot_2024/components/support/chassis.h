...
//底盘速度pid
#define CHASSIS_SPEED_PID_KP 2.5f
...
#define CHASSIS_YAW_PID_MAX_OUT 60.0f
...
{                
	...
	pid_type_def chassis_speed_pid_yaw;
...
extern void chassis_control(float x_set, float y_set, float yaw_set, uint8_t move_mode, chassis_move_t *chassis_move_control);
extern void chassis_odometry_reset(chassis_move_t *chassis_move_reset);
