...
//    accel_fliter_1[2] = accel_fliter_2[2] = accel_fliter_3[2] = INS_accel[2];
    ...
    imu_start_dma_flag = 1;
		...
		bmi088_offset_data.gyro[0] = -0.00460403552f; 
		bmi088_offset_data.gyro[1] = -0.00168488501f;
		bmi088_offset_data.gyro[2] = 0.00221254025f;
		mpu_offset_clc();
    ...
    while (1)
    {
        ...
        accel_fliter_3[2] = accel_fliter_2[2] * fliter_num[0] + accel_fliter_1[2] * fliter_num[1] + INS_accel[2] * fliter_num[2];
			...
			INS_angle_speed_deg[0] = bmi088_real_data.gyro[0] * 180.0f / 3.141592653589f;
			INS_angle_speed_deg[1] = bmi088_real_data.gyro[1] * 180.0f / 3.141592653589f;
			INS_angle_speed_deg[2] = bmi088_real_data.gyro[2] * 180.0f / 3.141592653589f;//这才是偏航角，666 -_-...
			ins_init_flag=1;
    }
}
...
const fp32 *get_INS_angle_deg_point(void)
{
    return INS_angle_deg;
}
const fp32 *get_INS_angle_speed_deg_point(void)
{
	return INS_angle_speed_deg;
}
/**
